                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Êtes-vous sûr de vouloir supprimer ce professeur?</h3>
                                </div>
                                <div class="card-body">
                                    <p><em style="color:red;"></em></p>
                                    <form class="forms-sample" action="manageprofEdit3.php" method="post">
                                    <input type="hidden" value="<?php echo $row1['id']?>" class="form-control" id="section" name="id" id="inputAddress">
                                        

                                        <div class="form-floating mb-3">
                                            <div class="col-md-6">
                                                <label for="exampleInputName1" value="<?php echo $row1['nomprof']?>"></label>
                                            </div>

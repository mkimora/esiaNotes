                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Modifier étudiant</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="manageetudiantEdit2.php" method="post">
                                        ...
                                        <div class="form-floating mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input name="nom" value="<?php echo $row1['nomEtudiant']?>" class="form-control" id="inputFirstName" type="text" placeholder="Entrer prénom et nom" required />
                                            </div>
                                        ...
                                        <div class="form-floating mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input name="date" value="<?php echo $row1['date_naissance']?>" class="form-control" id="inputEmail" type="date" placeholder="" required />
                                            </div>
                                        ...
                                        <div class="form-floating mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input name="lieunaiss" value="<?php echo $row1['lieu_naissance']?>" class="form-control" id="inputEmail" type="text" placeholder="" required />
                                            </div>
                                        ...
                                        <div class="form-floating mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input name="email" value="<?php echo $row1['email']?>" class="form-control" id="inputEmail" type="email" placeholder="Entrer email" required />
                                            </div>
                                        ...
                                        <div class="form-floating mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input name="mat" value="<?php echo $row1['matricule']?>" class="form-control" id="inputMatricule" type="text" placeholder="Entrer matricule" required />
                                            </div>
                                        ...
                                        <div class="form-floating mb-3">
                                        <div class="col-md-6">
                                        <input value="<?php echo $row1['sexe']?>" name="genre" class="form-control" id="inputSection" type="text" placeholder="Entrer genre" required />
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-floating mb-3">
                                        <div class="col-md-6">
                                        <input value="<?php echo $row1['section']?>" name="niveau" class="form-control" id="monselect" type="text" placeholder="Entrer genre" required />
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-floating mb-3">
                                        <div class="col-md-6">
                                        <input value="<?php echo $row1['grade']?>" name="grade" id="monselect" class="form-control" id="monselect" type="text" placeholder="Entrer genre" required />
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-floating mb-3">
                                        <div class="col-md-6">
                                        <input value="<?php echo $row1['classe']?>" name="classe" class="form-control" id="monselect" type="text" placeholder="Entrer genre" required />
                                        </div>
                                        </div>
